...
const TRANSLATIONS = {
  ...
  hi: {
    ...
    feat4_title: 'Claude AI सलाहकार', feat4_desc: 'Claude Sonnet 4.6 द्वारा संचालित — आपके सिस्टम का विश्लेषण करता है।',
    ...
    stat1: 'गेम्स सपोर्टेड', stat2: 'औसत पिंग कमी', stat3: 'Claude द्वारा संचालित', stat4: 'सेटअप समय',
  ...
  es: {
    ...
    stat1: 'Juegos compatibles', stat2: 'Reducción media de ping', stat3: 'Impulsado por Claude', stat4: 'Tiempo de configuración',
